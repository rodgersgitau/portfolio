...
export const WorkItem = ({
  ...
  return (
    <div className="relative w-full bg-white rounded-md shadow-lg dark:bg-black group shadow-black dark:shadow-brightGray/25">
      <div className="h-[30vh] flex rounded-lg">
        <div className="flex-1 w-full h-full">
          <Image
            priority
            alt={name}
            src={images[0]}
            className="object-cover rounded-l-lg w-full h-[30vh] aspect-square"
          />
        </div>

        <div className="flex flex-col justify-between flex-1 w-full h-full gap-8 p-4 rounded-r-lg bg-brightGray dark:bg-neutral-800">
