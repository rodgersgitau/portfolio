const ContactPage = () => {
  return (
    <section className="flex items-center justify-center">
      <div className="w-90 md:w-[40vw] h-full py-8">
          ...
          <div className="grid md:grid-cols-2 md:gap-6">
            <div className="relative z-0 w-full mb-6 group">
              ...
              <label
                ...
                className="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -tranpurple-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-purple-600 peer-focus:dark:text-purple-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:tranpurple-y-0 peer-focus:scale-75 peer-focus:-tranpurple-y-6"
              >
                First name
              </label>
            </div>
